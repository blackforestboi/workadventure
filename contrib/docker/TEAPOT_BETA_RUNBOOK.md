...
- While a vegetation preview is open, Browser B adds a blocking entity inside the region. Confirmation must reject the whole stale batch and create zero partial instances. Also verify selections above 64×64 tiles preview and submit successfully, while plans above 500 accepted instances are rejected before submission.
