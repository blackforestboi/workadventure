...
export interface FrontConfigurationInterface {
    ...
    BRAND_ERROR_LOGO_URL: string | undefined;
    BRAND_ERROR_IMAGE_URL: string | undefined;
    BRAND_LOADING_BACKGROUND_URL: string | undefined;
    BRAND_PWA_BACKGROUND_URL: string | undefined;
    BRAND_POWERED_BY_LOGO_URL: string | undefined;
    BRAND_STATUS_ICON_URL: string | undefined;
    BRAND_STATUS_CHARACTER_URL: string | undefined;
    BRAND_STATUS_FONT_IMAGE_URL: string | undefined;
    BRAND_STATUS_FONT_DATA_URL: string | undefined;
    BRAND_FAVICON_URL: string | undefined;
    BRAND_MANIFEST_ICON_URL: string | undefined;
    BRAND_CARD_IMAGE_URL: string | undefined;
