...
const mapEditor: BaseTranslation = {
    ...
    entityEditor: {
        ...
        assetGeneration: {
            descriptionRoleLabel: "Description guidance",
            object: "Object",
            styleMood: "Style / mood",
            referenceImages: "Reference images (kept only for this generation)",
            newImageRoleLabel: "New images are",
            objectReference: "Object reference",
            styleMoodGuide: "Style / mood guide",
            chooseRole: "Choose a role",
            dropImages: "Choose images or drop them here",
            removeReference: "Remove reference image",
            referenceRoleLabel: "Guidance role for reference {index}",
            roleSummary: "{objects} object reference(s) · {styles} style / mood guide(s)",
            reviewSummary: "Guidance used: {summary}; Description: {descriptionRole}",
            unclassifiedReference: "Choose a role for every attached image before generating.",
        },
        images: "Image{{s}}",
        noImage: "No image",
        specialTags: {
    ...
    stylePacks: {
        ...
        assetActions: "Actions for {name}",
        copyForStyle: "Copy for style",
        chooseDestination: "Choose a style",
        alreadyAdded: "Already added",
        copying: "Copying…",
        createAndCopy: "Create and copy",
        copiedTo: "Copied to {style}",
        view: "View",
        noTerrain: "No terrain assets in this style yet.",
        noObjects: "No objects in this style yet.",
        errors: {
            nameRequired: "Enter a style name.",
            nameTooLong: "Style names can contain up to 80 characters.",
            nameTaken: "A style with this name already exists.",
            createFailed: "The style could not be created.",
            copyFailed: "The asset could not be copied.",
        },
    },
    settings: {
        loading: "Loading",
