...
export const TEAPOT_MIGRATIONS_DIRECTORY = env.TEAPOT_MIGRATIONS_DIRECTORY;
export const TEAPOT_REQUIRE_PERSISTENCE = env.TEAPOT_REQUIRE_PERSISTENCE;
export const TEAPOT_MAP_STORAGE_WRITE_TOKEN = env.TEAPOT_MAP_STORAGE_WRITE_TOKEN;
export const TEAPOT_MCP_PUBLIC_URL = env.TEAPOT_MCP_PUBLIC_URL || "http://127.0.0.1:17374/mcp";
export const TEAPOT_MCP_APPROVAL_SECRET = env.TEAPOT_MCP_APPROVAL_SECRET || SECRET_KEY;
export const TEAPOT_AGENT_BRIDGE_URL = env.TEAPOT_AGENT_BRIDGE_URL || "";
export const TEAPOT_AGENT_BRIDGE_SECRET = env.TEAPOT_AGENT_BRIDGE_SECRET || "";
export const TEAPOT_WOKA_STORAGE_DIRECTORY = env.TEAPOT_WOKA_STORAGE_DIRECTORY || "storage/teapot-wokas";
export const TEAPOT_WOKA_PUBLIC_BASE_URL = env.TEAPOT_WOKA_PUBLIC_BASE_URL || PUSHER_URL;
export const TEAPOT_X_CLIENT_ID = env.TEAPOT_X_CLIENT_ID;
export const TEAPOT_X_CLIENT_SECRET = env.TEAPOT_X_CLIENT_SECRET;
export const TEAPOT_X_REDIRECT_URI =
    env.TEAPOT_X_REDIRECT_URI || (PUSHER_URL ? `${PUSHER_URL.replace(/\/+$/, "")}/teapot/auth/x/callback` : "");
export const TEAPOT_X_BOOTSTRAP_USER_IDS = env.TEAPOT_X_BOOTSTRAP_USER_IDS;
...
export const OPID_CLIENT_REDIRECT_URL = PUSHER_URL.replace(/\/+$/, "") + "/openid-callback";
export const OPID_CLIENT_REDIRECT_LOGOUT_URL = PUSHER_URL.replace(/\/+$/, "") + "/logout-callback";
