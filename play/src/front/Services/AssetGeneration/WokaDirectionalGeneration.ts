    ...
    return {
        ...
        prompt: [
            ...
            frame.direction === "left"
                ? "Canonical Side-view rule: generate only a strict LEFT-facing profile that points toward SCREEN-LEFT. Never turn this Side frame toward screen-right, because the right-facing output is created later by an exact horizontal pixel mirror of this image."
                : "",
