...
if (typeof window !== "undefined" && window.env === undefined) {
    const defaultEnv: FrontConfigurationInterface = {
        ...
        BRAND_WEBSITE_URL: "https://tpot.world",
        BRAND_CONTACT_EMAIL: "hello@tpot.world",
        BRAND_LOGO_URL: undefined,
        BRAND_LOADING_LOGO_URL: "https://assets.example.test/loading-logo.svg",
        BRAND_LOGIN_LOGO_URL: undefined,
        BRAND_ERROR_LOGO_URL: undefined,
        BRAND_ERROR_IMAGE_URL: undefined,
        BRAND_LOADING_BACKGROUND_URL: undefined,
        BRAND_PWA_BACKGROUND_URL: undefined,
        BRAND_POWERED_BY_LOGO_URL: undefined,
        BRAND_STATUS_ICON_URL: undefined,
        BRAND_STATUS_CHARACTER_URL: undefined,
        BRAND_STATUS_FONT_IMAGE_URL: undefined,
        BRAND_STATUS_FONT_DATA_URL: undefined,
        BRAND_FAVICON_URL: "https://assets.example.test/favicon.svg",
        BRAND_MANIFEST_ICON_URL: undefined,
        BRAND_CARD_IMAGE_URL: undefined,
        ADMIN_URL: undefined,
